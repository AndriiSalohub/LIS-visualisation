                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                          <li>
                            ...
                            - розташована зазвичай у верхній частині екрану і
                            містить посилання на основні розділи платформи, такі
                            як "Головна", "Документація" та інші. Це дозволяє
                            швидко переміщатися між різними частинами платформи.
                          </li>
                          <li>
                            <span className="font-semibold">
                              Область візуалізації
                            </span>{" "}
                            - центральна частина інтерфейсу, де динамічно
                            відображається поточний стан алгоритму. Ви побачите
                            кроки виконання, зміни в масиві та підсвічування
                            активних елементів.
                          </li>
                          <li>
                            <span className="font-semibold">
                            ...
                            - зазвичай знаходиться під або поруч з областю
                            візуалізації і містить елементи для контролю
                            візуалізації, такі як кнопки "Запуск", "Пауза",
                            "Крок вперед" та налаштування швидкості.
                          </li>
                          <li>
                            <span className="font-semibold">
                              Інформаційна панель
                            </span>{" "}
                            - може розташовуватися збоку або внизу екрану і
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                          ...
                          <li>
                            ...
                            - показує знайдені на даний момент підпослідовності
                            або допоміжні структури даних, які використовуються
                          ...
                          <li>
                            ...
                            - індикатор прогресу алгоритму, який може
                            відображатися у вигляді прогрес-бару або текстового
                            повідомлення, що показує поточний етап виконання.
                          </li>
                        </ul>
                      </div>
                    </AccordionContent>
                      ...
                      <div className="space-y-4">
                        ...
                        <ul className="list-disc pl-6 space-y-2">
                          <li>
                            ...
                            розділяючи їх пробілами або комами у відповідному
                            текстовому полі.
                          </li>
                          <li>
                            <span className="font-semibold">
